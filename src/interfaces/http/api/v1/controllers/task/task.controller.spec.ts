...
describe('TaskController', () => {
  ...
  describe('createTask', () => {
    it('should create a task successfully', async () => {
      ...
      expect(taskService.createTask).toHaveBeenCalledWith(createTaskDto, mockUser);
    ...
    it('should create a task with all optional fields', async () => {
      ...
      jest.spyOn(taskService, 'createTask').mockResolvedValue(taskWithAllFields as any);
  ...
  describe('updateTask', () => {
    it('should update a task successfully', async () => {
      ...
      expect(taskService.updateTask).toHaveBeenCalledWith('task-1', updateTaskDto, mockUser);
  ...
  describe('updateStatusTask', () => {
    it('should update task status successfully', async () => {
      ...
      jest.spyOn(taskService, 'updateStatusTask').mockResolvedValue(updatedTask as any);

      const result = await controller.updateStatusTask(param, updateStatusDto, mockUser);
    ...
    it('should update task status with order for drag & drop', async () => {
      ...
      const updatedTask = { ...mockTask, status: 'COMPLETED' as const, order: 5 };
